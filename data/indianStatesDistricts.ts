export const INDIAN_STATES_DISTRICTS: Record<string, string[]> = {
    ...
    "Assam": [
        ...
        "Lakhimpur", "Majuli", "Morigaon", "Nagaon", "Nalbari", "North Cachar Hills",
    ...
    "Punjab": [
        ...
        "Kapurthala", "Ludhiana", "Mansa", "Moga", "Muktsar", "Nawanshahr (Shahid Bhagat Singh Nagar)",
    ...
    "Tamil Nadu": [
        ...
        "Dharmapuri", "Dindigul", "Erode", "Kallakurichi", "Kanchipururam",
    ...
    "Uttar Pradesh": [
        ...
        "Gonda", "Gorakhpur", "Hamirpur", "Hapur (Panchsheel Nagar)", "Hardoi",
        ...
        "Sambhal (Bhim Nagar)", "Sant Kabir Nagar", "Shahjahanpur", "Shamli",
    ...
    "West Bengal": [
        ...
        "Paschim Medinipur (West Medinipur)", "Paschim (West) Burdwan (Bardhaman)",
        "Purba Burdwan (Bardhaman)", "Purba Medinipur (East Medinipur)", "Purulia",
